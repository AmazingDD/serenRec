...
- This repository also contains the related code for our article published in IJCAI'2025, "Cost-Effective On-Device Sequential Recommendation with Spiking Neural Networks", located in `seren.recommender.ssr`. The name SSR stands for Spike-wise Sequential Recommendation.
